    ...
    <div className="min-h-screen bg-gray-50 px-6 py-12 font-inter">
      ...
      <div className="max-w-4xl mx-auto text-center mb-20">
        <img
          src={teamPhoto}
          alt="Our Team"
          className="rounded-xl shadow-md max-w-md w-full h-auto object-cover mx-auto"
        />
        <p className="text-xs text-gray-400 mt-2 italic mb-6">Image generated with ChatGPT</p>

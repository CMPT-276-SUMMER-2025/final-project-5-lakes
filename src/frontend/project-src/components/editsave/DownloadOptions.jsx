...
// downloadChart: Handles fetching and triggering file download based on format
...
// DownloadOptions: Modal for choosing file format and confirming chart download
function DownloadOptions({ onClose, chartImageUrl }) {
  ...
  // Button handlers
  const handleContinueEditing = () => onClose();
  ...
  // Attach/remove escape key listener
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* If download was successful, show success message and next steps */}
        {downloadSuccessful ? (
          <div>
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-gray-600 text-center mb-6">
                Your chart has been successfully downloaded.
              </p>
            </div>
